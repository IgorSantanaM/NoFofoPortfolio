...
export const creations: Creation[] = [
  { 
    id: 'abraco', 
    name: 'Um pequeno abraço', 
    category: 'Amigurumis', 
    description: 'Uma ideia de amigurumi para fazer companhia e transformar um presente em lembrança.',
     note: 'Personagem, cores e tamanho a definir em uma conversa.',
      tone: 'rose', 
      motif: 'loops',
       image: null, imageAlt: '', 
       provisional: true },
